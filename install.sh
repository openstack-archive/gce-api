...
#this default values are for devstack. change it for real cloud (NETWORK_API=nova, REGION_LIST=ocs for example)
NETWORK_API=quantum
REGION_LIST=nova
...
iniset $CONF_FILE DEFAULT public_url "$PUBLIC_URL"
iniset $CONF_FILE DEFAULT network_api "$NETWORK_API"
iniset $CONF_FILE DEFAULT region_list "$REGION_LIST"
